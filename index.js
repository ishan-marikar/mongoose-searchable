...
function parseKeywords(content, options, done) {
  ...
  var extract = options && options.extract ? options.extract : extractor;
...
module.exports = exports = function(schema, options) {
  ...
  schema.statics.search = function(keywords, searchOptions, callback) {
    ...
    if (
      (_.isArray(keywords) || _.isString(keywords)) &&
      _.isFunction(searchOptions)
    ) {
    ...
    //normalize keywords
    keywords = keywords && _.isArray(keywords) ? keywords.join(" ") : keywords;
